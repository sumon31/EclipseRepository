...
public class LoginAndSetPersonnelDetach {
...
//    	 Thread.sleep(7000);
    	 ...
    	 //set equipment up
	      ObjectRepository.SetPersonnelDetached opsDetach = new ObjectRepository.SetPersonnelDetached(driver);
	      opsDetach.TestScenario();
